...
import org.w3c.dom.*;
import java.io.*;
public class Personatge2 extends Personatges {
    public Personatge2(String nom, int nivell, int puntsDeVida, int puntsDeMana, int danys) {
        super(nom, nivell, puntsDeVida, puntsDeMana, danys);
    }
    public void equiparPersonatge2(String nomArma, int danysArma, String nomArmadura, int puntsDeVidaArmadura, String nomPocio, int puntsDeVidaPocio, int puntsDeManaPocio) {
        try {
            // EQUIPAR ARMA
            ...
            Node nodeArma = nListArma.item(1);
            ...
            Node nodeArmadura = nListArmadura.item(1);
            ...
            Node nodePocio = nListPocio.item(1);
